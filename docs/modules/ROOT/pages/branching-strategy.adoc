...
When the same vulnerability needs to be tracked in multiple files, the xref:cli-copy.adoc[`vulnlog modify copy`] command propagates an entry from one file to others without manual duplication.
