...
| String (enum)
| Conditional
| Severity assessment. Required when `verdict` is `affected` or `risk acceptable`. See xref:reference/verdicts-and-justifications.adoc#severity-values[Severity Values].
