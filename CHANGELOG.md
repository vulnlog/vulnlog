...
### Changed
- Add discussions write permission to CD workflow by @ryru in [#40](https://github.com/vulnlog/vulnlog/pull/40)
- Update for refs/tags/v0.9.2 by @github-actions[bot]
