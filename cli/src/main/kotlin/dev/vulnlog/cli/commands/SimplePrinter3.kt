...
import dev.vulnlog.dsl3.ReleaseVersionData
...
class SimplePrinter3(
    ...
    fun printNicely(evalResult: Result<Triple<VlDslReleasesImpl, VlDslVulnImpl, MyVuln>>) {
        evalResult.onFailure {
            ...
            val vulnerabilities: List<VulnlogData> = entry.third.data
